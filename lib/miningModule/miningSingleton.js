...
// Integrity Check
if(MiningService.shared() === MiningSingleton.shared())
{
    // MiningService.shared().chicken = "chicken chicken chicken"
    // console.log("%o", MiningSingleton.shared().chicken);
    // MiningService.shared().helloWorld();
    MiningSingleton.shared().helloWorld();
}
else
{
    console.log("MiningService / MiningSingleton failed to return same shared() instance...");
}
